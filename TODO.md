...
- [ ] **#47-orig** **Extract the pure logic out of `src/index.ts` and put tests on it.** Not a general "split the architecture" — a narrow move, ~200 lines, with no change to the tool surface.
